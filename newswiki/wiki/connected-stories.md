...
- 先問：呢篇報道接喺邊條既有線索（算力、就業、消費、監管等）。
- 用 `[[wiki links]]`、主題索引同 [[hubs/nvidia|實體 hub]] 將相關篇目互見，而唔係孤立摘要。
- 時間線同因果分開寫：何日發生係事實；點解如此若屬推斷，標 `[AI Synthesis]`。
- 主張要可以回溯：同 [[verifiable-sources|來源核實]] 一齊讀。
